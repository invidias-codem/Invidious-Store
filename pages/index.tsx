    ...
    <main className="mx-auto max-w-7xl px-4 py-24 sm:px-6">
      <div className="flex flex-col items-center text-center gap-10">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-4 font-gothic-ui text-5xl tracking-[0.18em] sm:text-6xl md:text-7xl">Invidious</h1>
        ...
        <div className="mt-16 border-t border-invidious-border pt-10 w-full max-w-3xl">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
            <div>
              ...
              <h2 className="mt-2 font-gothic-ui text-2xl tracking-[0.18em] sm:text-3xl">Garments</h2>
            ...
            <div>
              ...
              <h2 className="mt-2 font-gothic-ui text-2xl tracking-[0.18em] sm:text-3xl">Retro Sovereignty</h2>
              <p className="mt-3 text-sm leading-relaxed text-gray-400">
